      ...
      <Card className="shadow-lg max-w-4xl mx-auto bg-transparent border-0">
        ...
        <CardContent className="space-y-6 text-sm leading-relaxed text-muted-foreground">
          <p>
            ...
            <a className="underline text-yellow-500" href="www.amaanahepos.co.uk"> www.amaanahepos.co.uk</a> and the
            services provided thereof. Your use of this site indicates your
            agreement to these terms and that you will conduct yourself
